...
description: The Apache Grails (incubating) community is pleased to announce is excited to announce the Milestone [%version] release of Grails Framework!
...
The Apache Grails (incubating) community is excited for the release of Grails Framework [%version]. \
...
## Installing Grails [%version]
Try out Grails [%version] today by visiting the online app creator * [Grails Forge](https://start.grails.org/).
Alternatively, you can quickly install Grails [%version] using the [SDKMan](https://sdkman.io/).
...
improvements in Grails [%version]. Happy coding!
