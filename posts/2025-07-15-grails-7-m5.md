...
description: The Apache Grails (incubating) community is excited to announce the Milestone [%version] release of Grails Framework!
...
Alternatively, you can quickly install Grails CLIs (grails-shell-cli and grails-forge-cli) [%version] using [SDKMan](https://sdkman.io/).
